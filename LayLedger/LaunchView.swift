...
//  LayLedger
//
//  Thematic splash: shifting warm gradient, floating eggs, spring logo entrance,
//  staged by a single coordinator timer with full animation cleanup on disappear.
//
